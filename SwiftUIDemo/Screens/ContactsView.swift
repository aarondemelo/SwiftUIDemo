        ...
        NavigationStack {
            List {
                ForEach(filteredSections) { section in
                    Section(header: Text(section.id).font(.headline).foregroundColor(.black).background(Color(UIColor.systemGray5))) {
                            ...
                            Text(contact.name)
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 4)
                                        .stroke(contact.id == selectedContact ? Color.purple : Color.clear, lineWidth: 1)
                                )
                                .onTapGesture {
